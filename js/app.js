...
(function () {
  ...
  function renderReport() {
    ...
    node.innerHTML = `
      ...
      <p class="footer-note">For educational &amp; decision-support purposes only. Sidereal (Lahiri) calculations — Build v5.5</p>
...
<p class="footer-note" style="text-align:center;margin-top:24px;opacity:.7;font-size:11.5px">
  For educational &amp; decision-support purposes only. Sidereal (Lahiri) calculations. Build v5.5
</p>
